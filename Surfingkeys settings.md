...
settings.theme = `
  ...
  .sk_omnibar_middle {
    top: 10%;
  chrome-extension://gfbliohnnapiefjpjlpjnehglfpaknnc/pages/options.html chrome-extension://gfbliohnnapiefjpjlpjnehglfpaknnc/pages/options.html border-radius: 4px;
  }
  .sk_omnibar_bottom {
    bottom: 0;
